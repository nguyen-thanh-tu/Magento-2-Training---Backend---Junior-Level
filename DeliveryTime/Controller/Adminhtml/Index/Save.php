...
use TUTJunior\DeliveryTime\Model\DeliveryTimeFactory;
...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            return $resultRedirect->setPath('*/*/edit', ['tut_delivery_time_id' => $this->getRequest()->getParam('tut_delivery_time_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
